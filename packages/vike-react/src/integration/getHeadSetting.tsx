...
import type { ConfigViaComponentResolved } from '../types/Config.js'
...
function getHeadSetting<T>(
  configName: keyof ConfigViaComponentResolved,
  pageContext: PageContext & PageContextInternal,
): undefined | T {
  // Set by useConfig()
  const valFromUseConfig = pageContext._configViaComponent?.[configName]
